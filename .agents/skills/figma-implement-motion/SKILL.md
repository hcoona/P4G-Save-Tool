...
- If the user asks to create/edit animations inside Figma itself, switch to [figma-use](../../../apm_modules/figma/mcp-server-guide/skills/figma-use/SKILL.md) and follow that skill instead.
