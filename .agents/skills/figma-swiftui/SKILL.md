...
6. **For code → design, `use_figma` is the API.** Always load [`figma-use`](../../../apm_modules/figma/mcp-server-guide/skills/figma-use/SKILL.md) before any `use_figma` call. If the task involves building a full screen, also load [`figma-generate-design`](../../../apm_modules/figma/mcp-server-guide/skills/figma-generate-design/SKILL.md); if it involves building components or a design system, also load [`figma-generate-library`](../../../apm_modules/figma/mcp-server-guide/skills/figma-generate-library/SKILL.md).
