...
Motion context for the `use_figma` MCP tool. [figma-use](../../../apm_modules/figma/mcp-server-guide/skills/figma-use/SKILL.md) covers the foundational Plugin API rules — load both together.
...
Static design work (creating shapes, components, variables, layout) goes through [figma-use](../../../apm_modules/figma/mcp-server-guide/skills/figma-use/SKILL.md) alone — this skill is only for the time dimension.
...
In addition to the [figma-use pre-flight checklist](../../../apm_modules/figma/mcp-server-guide/skills/figma-use/SKILL.md#8-pre-flight-checklist), verify:
